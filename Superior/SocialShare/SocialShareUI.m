...
;
    ...
    [button mas_makeConstraints:^(MASConstraintMaker *make) {
        NSLayoutConstraint *left = [NSLayoutConstraint constraintWithItem:button attribute:(NSLayoutAttributeLeading) relatedBy:(NSLayoutRelationEqual) toItem:containView attribute:(NSLayoutAttributeLeading) multiplier:1.0 constant:0];
        [containView addConstraint:left];

        NSLayoutConstraint *right = [NSLayoutConstraint constraintWithItem:button attribute:(NSLayoutAttributeTrailing) relatedBy:(NSLayoutRelationEqual) toItem:containView attribute:(NSLayoutAttributeTrailing) multiplier:1.0 constant:0];
        [containView addConstraint:right];
        ...
        NSLayoutConstraint *height = [NSLayoutConstraint constraintWithItem:button attribute:(NSLayoutAttributeHeight) relatedBy:(NSLayoutRelationEqual) toItem:nil attribute:(NSLayoutAttributeNotAnAttribute) multiplier:1.0 constant:bottomHeight];
    ...
    [breakLine mas_makeConstraints:^(MASConstraintMaker *make) {
        NSLayoutConstraint *left = [NSLayoutConstraint constraintWithItem:breakLine attribute:(NSLayoutAttributeLeading) relatedBy:(NSLayoutRelationEqual) toItem:button attribute:(NSLayoutAttributeLeading) multiplier:1.0 constant:0];
        [button addConstraint:left];

        NSLayoutConstraint *right = [NSLayoutConstraint constraintWithItem:breakLine attribute:(NSLayoutAttributeTrailing) relatedBy:(NSLayoutRelationEqual) toItem:button attribute:(NSLayoutAttributeTrailing) multiplier:1.0 constant:0];
        [button addConstraint:right];

        NSLayoutConstraint *bottom = [NSLayoutConstraint constraintWithItem:breakLine attribute:(NSLayoutAttributeTop) relatedBy:(NSLayoutRelationEqual) toItem:button attribute:(NSLayoutAttributeTop) multiplier:1.0 constant:0];
        [button addConstraint:bottom];

        NSLayoutConstraint *height = [NSLayoutConstraint constraintWithItem:breakLine attribute:(NSLayoutAttributeHeight) relatedBy:(NSLayoutRelationEqual) toItem:nil attribute:(NSLayoutAttributeNotAnAttribute) multiplier:1.0 constant:1];
        [breakLine addConstraint:height];
    }];

    //内容布局
    [contentView mas_makeConstraints:^(MASConstraintMaker *make) {
        NSLayoutConstraint *left = [NSLayoutConstraint constraintWithItem:contentView attribute:(NSLayoutAttributeLeading) relatedBy:(NSLayoutRelationEqual) toItem:containView attribute:(NSLayoutAttributeLeading) multiplier:1.0 constant:0];
        [containView addConstraint:left];

        NSLayoutConstraint *right = [NSLayoutConstraint constraintWithItem:contentView attribute:(NSLayoutAttributeTrailing) relatedBy:(NSLayoutRelationEqual) toItem:containView attribute:(NSLayoutAttributeTrailing) multiplier:1.0 constant:0];
        [containView addConstraint:right];

        NSLayoutConstraint *bottom = [NSLayoutConstraint constraintWithItem:contentView attribute:(NSLayoutAttributeBottom) relatedBy:(NSLayoutRelationEqual) toItem:button attribute:(NSLayoutAttributeTop) multiplier:1.0 constant:0];
        [containView addConstraint:bottom];

        NSLayoutConstraint *height = [NSLayoutConstraint constraintWithItem:contentView attribute:(NSLayoutAttributeHeight) relatedBy:(NSLayoutRelationEqual) toItem:nil attribute:(NSLayoutAttributeNotAnAttribute) multiplier:1.0 constant:contentHeight];
    ...
    [TopView mas_makeConstraints:^(MASConstraintMaker *make) {
        NSLayoutConstraint *left = [NSLayoutConstraint constraintWithItem:TopView attribute:(NSLayoutAttributeLeading) relatedBy:(NSLayoutRelationEqual) toItem:containView attribute:(NSLayoutAttributeLeading) multiplier:1.0 constant:0];
        [containView addConstraint:left];

        NSLayoutConstraint *right = [NSLayoutConstraint constraintWithItem:TopView attribute:(NSLayoutAttributeTrailing) relatedBy:(NSLayoutRelationEqual) toItem:containView attribute:(NSLayoutAttributeTrailing) multiplier:1.0 constant:0];
        [containView addConstraint:right];

        NSLayoutConstraint *top = [NSLayoutConstraint constraintWithItem:TopView attribute:(NSLayoutAttributeTop) relatedBy:(NSLayoutRelationEqual) toItem:containView attribute:(NSLayoutAttributeTop) multiplier:1.0 constant:0];
        [containView addConstraint:top];

        NSLayoutConstraint *height = [NSLayoutConstraint constraintWithItem:TopView attribute:(NSLayoutAttributeHeight) relatedBy:(NSLayoutRelationEqual) toItem:nil attribute:(NSLayoutAttributeNotAnAttribute) multiplier:1.0 constant:topHeight];
        [TopView addConstraint:height];
    }];
    ...
    [title mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        NSLayoutConstraint *right = [NSLayoutConstraint constraintWithItem:title attribute:(NSLayoutAttributeCenterY) relatedBy:(NSLayoutRelationEqual) toItem:TopView attribute:(NSLayoutAttributeCenterY) multiplier:1.0 constant:5];
        [TopView addConstraint:right];
    }];
    ...
    [leftBreak mas_makeConstraints:^(MASConstraintMaker *make) {
        NSLayoutConstraint *right = [NSLayoutConstraint constraintWithItem:leftBreak attribute:(NSLayoutAttributeRight) relatedBy:(NSLayoutRelationEqual) toItem:title attribute:(NSLayoutAttributeLeft) multiplier:1.0 constant:-10];
        [TopView addConstraint:right];
        ...
        //
        NSLayoutConstraint *height = [NSLayoutConstraint constraintWithItem:leftBreak attribute:(NSLayoutAttributeHeight) relatedBy:(NSLayoutRelationEqual) toItem:nil attribute:(NSLayoutAttributeNotAnAttribute) multiplier:1.0 constant:1];
        [leftBreak addConstraint:height];

        NSLayoutConstraint *width = [NSLayoutConstraint constraintWithItem:leftBreak attribute:(NSLayoutAttributeWidth) relatedBy:(NSLayoutRelationEqual) toItem:nil attribute:(NSLayoutAttributeNotAnAttribute) multiplier:1.0 constant:80];
        [leftBreak addConstraint:width];
    }];
    ...
    [rightBreak mas_makeConstraints:^(MASConstraintMaker *make) {
        NSLayoutConstraint *right = [NSLayoutConstraint constraintWithItem:rightBreak attribute:(NSLayoutAttributeLeft) relatedBy:(NSLayoutRelationEqual) toItem:title attribute:(NSLayoutAttributeRight) multiplier:1.0 constant:10];
        [TopView addConstraint:right];

        NSLayoutConstraint *centerY = [NSLayoutConstraint constraintWithItem:rightBreak attribute:(NSLayoutAttributeCenterY) relatedBy:(NSLayoutRelationEqual) toItem:title attribute:(NSLayoutAttributeCenterY) multiplier:1.0 constant:0];
        [TopView addConstraint:centerY];

        NSLayoutConstraint *height = [NSLayoutConstraint constraintWithItem:rightBreak attribute:(NSLayoutAttributeHeight) relatedBy:(NSLayoutRelationEqual) toItem:nil attribute:(NSLayoutAttributeNotAnAttribute) multiplier:1.0 constant:1];
        [rightBreak addConstraint:height];

        NSLayoutConstraint *width = [NSLayoutConstraint constraintWithItem:rightBreak attribute:(NSLayoutAttributeWidth) relatedBy:(NSLayoutRelationEqual) toItem:nil attribute:(NSLayoutAttributeNotAnAttribute) multiplier:1.0 constant:80];
        [rightBreak addConstraint:width];
    }];
