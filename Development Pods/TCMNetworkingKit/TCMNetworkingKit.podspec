...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TCMNetworkingKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Dao/TCMNetworkingKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dao' => 'cilike@sina.cn' }
  s.source           = { :git => 'https://github.com/Dao/TCMNetworkingKit.git', :tag => s.version.to_s }
