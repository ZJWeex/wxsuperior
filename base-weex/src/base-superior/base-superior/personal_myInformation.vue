    ...
    <div>
        ...
        <scroller class="scroller">
            <div v-for="(item, index) in rows" :key="index" :class="[index === 0?'otherRow':'row']">
                ...
                <!-- <div > -->
                <div v-if="item.type == 1" class="avatarsContent" style="margin-right:25px" @click="changeAvatars">
                ...
                <div v-else-if="item.type == 0">
                    <text style="padding-right:25px;font-size: 26px;">{{userInfo.userName}}</text>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            femaleIconImg: "/web/assets/myInfo/femaleNormal.png",
            maleIconImg: "/web/assets/myInfo/maleNormal.png",
            arrow: "/web/assets/personal/next.png",
            currentDate: "",
            defaultDate: "",
            rows: [{name: "头像",type: 1}, {name: "用户名",type: 0}, {name: "昵称",type: 2}, {name: "性别",type: 3}, {name: "出生日期",type: 4}
            ]
        };
    },
    created: function() {
        ...
        storage.getItem("customer_userInfo", event => {
            if (event.result == "success") {
                ...
                if (that.userInfo.sex === "0") {
                    that.femaleIconImg = "/web/assets/myInfo/femaleSelected.png";
                    that.maleIconImg = "/web/assets/myInfo/maleNormal.png";
                } else if (that.userInfo.sex === "1") {
                    that.maleIconImg = "/web/assets/myInfo/maleSelected.png";
                    that.femaleIconImg = "/web/assets/myInfo/femaleNormal.png";
                } else {
                    that.femaleIconImg = "/web/assets/myInfo/femaleNormal.png";
                    that.maleIconImg = "/web/assets/myInfo/maleNormal.png";
                }
    ...
    methods: {
        ...
        genderClick: function(tag) {
            ...
            if (tag == 0) {
                message = "女";
                this.femaleIconImg = "/web/assets/myInfo/femaleSelected.png";
                this.maleIconImg = "/web/assets/myInfo/maleNormal.png";
                this.userInfo.sex = '0'
            } else {
                message = "男";
                this.maleIconImg = "/web/assets/myInfo/maleSelected.png";
                this.femaleIconImg = "/web/assets/myInfo/femaleNormal.png";
                this.userInfo.sex = '1'
            }
            modal.toast({
                message: message,
