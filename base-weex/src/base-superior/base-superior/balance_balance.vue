    ...
    <div class='wrapper'>
        ...
        <div>
            ...
            <div class="account-info">
                ...
                <div class="pay-div">
                    <text class="pay" @click="payClick(1)">充值</text>
                    <text class="setPwd" @click="payClick(2)">{{payPwdString}}</text>
                </div>
            </div>
            <!-- 交易明细(-年-月) -->
...
export default {
    ...
    data() {
        return {
            redeemCodeChannel: {},
            shadowImg: "/web/assets/accountBalance/balanceTopShadow.png",
            downArrow: "/web/assets/accountBalance/balanceDownArrow.png",
            spCardBalance: "0.00",
            yearStr: "",
            monthStr: "",
            dateValue: '',
