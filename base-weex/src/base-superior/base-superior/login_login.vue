    ...
    <div>
        ...
        <div class='wrapper' @viewappear="viewappear" @viewdisappear="viewdisappear">
            <div style="width: 580px;justify-content:flex-start">
                <!-- 输入手机号 -->
                <div class="phone-div">
                    <image class="phoneIcon" src="/web/assets/login/loginPhoneIcon.png" />
            ...
            <div class="prcol-info">
                <image class="selectIcon" resize="contain" :src="selectAgree ? Agree : unAgree" @click="onSelectProtocol" />
...
export default {
    ...
    data() {
        return {
            ...
            phoneNumber: "",
            codeText: "",
            unAgree:"/web/assets/login/unagreeicon.png",
            Agree:"/web/assets/login/agreeicon.png",
            selectAgree: true,
            //登录返回的用户信息
            userInfo: {
                sessionid: "",
    ...
    methods: {
        ...
        onProtocol: function(number) {
            ...
            if (number == 1) {
                console.log("服务协议");
                var objc = {url:'http://www.taocaimall.com/agreement/',
                            title:'服务协议'}
        ...
        onLoginClick: function() {
            ...
            if (enable) return;
            this.loading = true;
            var param = { username: this.phoneNumber, code: this.codeText };
            const self = this;
            Fetch.post(
                "app_sms_login.json",
                param,
