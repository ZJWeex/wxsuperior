<template>
    <div class='wrapper'>
        ...
        <div style="width:750px;flex:1;">
            ...
            <!-- 优惠券列表 -->
            <list class="list">
                <cell v-for="(model,i) in updateList" :key="i">
                    <couponCell :itemType="100" :item="model" v-bind="model" @didSelectClick="selectCouponClick(i,$event)"></couponCell>
                </cell>
            </list>
...
export default {
    ...
    methods: {
        ...
        nonUseCouponClick: function() {
            ...
            navigator.pop({animated:"true"},function(value){})
        },
        //选择优惠券
