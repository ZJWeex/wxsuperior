<template>
    <div class='wrapper' @click="didSelectClick">
        <div class="content-left">
            ...
            <div class="state-tag" :style="{'background-color':getCouponCong(item).tagColor, height:getCouponCong(item).stateTitle.length>0 ? '114px':0}">
        ...
        <div class="content-right">
            ...
            <text style="font-size: 22px;color:#333333;padding-top:10px;padding-right:40px;">{{ getCouponCong(item).useInfo }}</text>
            <div v-if="itemType == 100" class="select-img">
                <image v-if="checked==true" style="width: 36px; height: 36px;" src='/web/assets/coupon/selectcoupon.png'/>
    ...
    methods: {
        ...
        getCouponCong:function(item){
            ...
            if(useType == 1){
                color = '#eacf3a';
                tagColor = '#eacf3a';
                img = '/web/assets/coupon/common_discount.png';
                useInfo = item.type;
            }else if(useType == 2){
                color = '#ff0033';
                tagColor = '#ff0033';
                if(mergeAble == 1){
                    img = '/web/assets/coupon/coupon_mergeable.png';
                }else{
                    img = '/web/assets/coupon/nomal_coupon.png';
                }
            }else if(useType == 3){
                color = '#ffa800';
                tagColor = '#ffa800';
                img = '/web/assets/coupon/zone_coupon.png';
            }else if(useType == 4){
                color = '#58b2cc';
                tagColor = '#58b2cc';
                img = '/web/assets/coupon/store_coupon.png';
            }else if(useType == 5){
                
            }else if(useType == 6){
                color = '#48a23f';
                tagColor = '#48a23f';
                img = '/web/assets/coupon/youpin_coupn.png';
            }else if(useType == 7){
                color = '#ff0033';
                tagColor = '#ff0033';
                img = '';
                ...
                color = '#f9670f';
                tagColor = '#f9670f';
                img = '/web/assets/coupon/coupon_category.png';
            }else if(useType == 10){
                color = '#b71c47';
                tagColor = '#b71c47';
                img = '/web/assets/coupon/goods_coupon.png';
            }else if(useType == 1000){
                color = '#f9670f';
                tagColor = '#f9670f';
                img = '/web/assets/coupon/nomal_discount.png';
            }else if(useType == 1001 || useType == 1004){
                color = '#7c7dde';
                tagColor = '#7c7dde';
                img = '/web/assets/coupon/fast_discount.png';
            }else if(useType == 1002){
                
            }else if(useType == 1003){
                color = '#cc79bf';
                tagColor = '#cc79bf';
                img = '/web/assets/coupon/zone_discount.png';
            }
            var stateTitle = '';
            if(this.itemType == 1){
                //未使用
                ...
                tagColor = '#ebeaea';
                if(useType == 1){
                    img = '/web/assets/coupon/common_discount_invalid.png';
                }else if(useType == 2){
                    if(mergeAble == 1){
                        img = '/web/assets/coupon/coupon_mergeable_invalid.png';
                    }else{
                        img = '/web/assets/coupon/nomal_coupon_invalid.png';
                    }
                }else if(useType == 3){
                    img = '/web/assets/coupon/nomal_coupon_invalid.png';
                }else if(useType == 4){
                    img = '/web/assets/coupon/store_coupon_invalid.png';
                }else if(useType == 5){
                    img = '';
                }else if(useType == 6){
                    img = '/web/assets/coupon/youpin_coupn_invalid.png';
                }else if(useType == 7){
                    img = '';
                }else if(useType == 8){
                    img = '';
                    ...
                    img = '/web/assets/coupon/goods_coupon_invalid.png';
                }else if(useType == 1000){
                    img = '/web/assets/coupon/nomal_discount_invalid.png';
                }else if(useType == 1001 || useType == 1004){
                    img = '/web/assets/coupon/fast_discount_invalid.png';
                }
