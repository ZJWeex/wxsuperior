    ...
    <div class='root' @viewappear="viewappear">
        ...
        <div class="search">
            <div class="input-content">
                <image style="height:30px;width:30px;margin-left:30px;" src="/web/assets/sup/sup_homeSearch_icon.png"/>
                ...
                <div style="padding-right:10px;padding-left:10px;" @click="cancelInput">
                    <image v-if="inputStr != ''" style="width: 30px; height: 30px; margin: 10px;" resize="contain" src='/web/assets/sup/sup_personal_cancle_input.png' @click="cancelInput"/>
                </div>
            </div>
        </div>
        ...
        <list style="width:750px;flex:1;">
            <cell>
                <div v-if="isShowEmty" class="emty-view">
                    ...
                    <text style="color:#666;font-size:30px;">请搜索该城市内您收货的写字楼、小区</text>
                </div>
            </cell>
...
export default {
    ...
    created() {
        ...
        let promiseGeoSearch = function(userLocation){
            return Define.getItem('city_POI').then((event)=>{
                ...
                Define.removeItem('city_POI',event => {})
