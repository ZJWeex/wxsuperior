...
export default {
  ...
  methods: {
    ...
    initDataList(){
      // this.rows.push({
      //     icon: "/web/assets/sup/sup_setting_noticeIcon.png",
      //     name: "推送通知设置",
      //     type: 1,
      ...
      // this.rows.push({
      //     icon: "/web/assets/sup/sup_setting_removeIcon.png",
      //     name: "清除缓存",
      //     type: 2,
      //     custom_index: 1
      //   })
      this.rows.push({
          icon: "/web/assets/sup/sup_setting_aboutUsIcon.png",
          name: "关于我们",
          type: 0,
          custom_index: 2
        })
      ...
      if(WXEnvironment.platform === 'iOS'){
        // this.rows.push({
        //     icon: "/web/assets/sup/sup_setting_starIcon.png",
        //     name: "欢迎评分",
        //     type: 0,
        //     custom_index: 3
        //   })
        ...
        this.rows.push({
          icon: "/web/assets/sup/sup_setting_declareIcon.png",
          name: "特别声明",
          type: 0,
          custom_index: 4
        })
      ...
      this.rows.push({
          icon: "/web/assets/sup/sup_setting_privacyIcon.png",
          name: "隐私权政策",
          type: 0,
          custom_index: 5
        })
